...
/*
mdupont  
here are the entry points, we now use the dump_info to hold all variables, 
including the stream.

*/
extern dump_info_p dump_begin		PARAMS ((dump_info_p,enum tree_dump_index));
extern dump_info_p dump_begin_function	PARAMS ((dump_info_p,enum tree_dump_index,tree));
extern void dump_end			PARAMS ((dump_info_p,enum tree_dump_index));
extern void dump_node			PARAMS ((dump_info_p,tree, int ));
